...
// Complete sample data from user (with corrected position ratings)
const SAMPLE_DATA = [
  {
    ...
    primary: "LB", secondary: "", ST: 36, CF: 46, CAM: 47, RW: 46, LW: 46, RM: 52, LM: 64, CM: 52, CDM: 61, RWB: 62, LWB: 77, RB: 74, LB: 82, CB: 76, GK: 0
  },
  {
    ...
    primary: "RM", secondary: "ST", ST: 68, CF: 50, CAM: 48, RW: 65, LW: 50, RM: 64, LM: 56, CM: 56, CDM: 39, RWB: 52, LWB: 40, RB: 52, LB: 40, CB: 36, GK: 0
  },
  {
    ...
    primary: "RWB", secondary: "RM, CM", ST: 49, CF: 54, CAM: 55, RW: 66, LW: 54, RM: 76, LM: 57, CM: 76, CDM: 58, RWB: 78, LWB: 70, RB: 73, LB: 58, CB: 57, GK: 0
  },
  {
    ...
    primary: "CAM", secondary: "ST", ST: 79, CF: 78, CAM: 84, RW: 63, LW: 63, RM: 58, LM: 58, CM: 73, CDM: 51, RWB: 37, LWB: 37, RB: 37, LB: 37, CB: 23, GK: 0
  },
  {
    ...
    primary: "RM", secondary: "ST, LM", ST: 60, CF: 38, CAM: 37, RW: 53, LW: 38, RM: 54, LM: 53, CM: 46, CDM: 24, RWB: 35, LWB: 23, RB: 35, LB: 23, CB: 16, GK: 0
  },
  {
    ...
    primary: "ST", secondary: "", ST: 85, CF: 73, CAM: 56, RW: 58, LW: 58, RM: 46, LM: 46, CM: 46, CDM: 31, RWB: 31, LWB: 31, RB: 31, LB: 31, CB: 23, GK: 0
  },
  {
    ...
    primary: "ST", secondary: "LM", ST: 78, CF: 71, CAM: 55, RW: 56, LW: 56, RM: 48, LM: 67, CM: 48, CDM: 34, RWB: 34, LWB: 34, RB: 34, LB: 34, CB: 25, GK: 0
  },
  {
    ...
    primary: "ST", secondary: "", ST: 97, CF: 92, CAM: 77, RW: 77, LW: 77, RM: 74, LM: 74, CM: 74, CDM: 64, RWB: 63, LWB: 63, RB: 63, LB: 63, CB: 56, GK: 0
  },
  {
    ...
    primary: "LW", secondary: "", ST: 58, CF: 64, CAM: 64, RW: 76, LW: 84, RM: 60, LM: 75, CM: 60, CDM: 46, RWB: 45, LWB: 57, RB: 45, LB: 45, CB: 32, GK: 0
  },
  {
    ...
    primary: "RM", secondary: "ST", ST: 80, CF: 64, CAM: 65, RW: 79, LW: 64, RM: 86, LM: 78, CM: 78, CDM: 64, RWB: 74, LWB: 62, RB: 74, LB: 62, CB: 61, GK: 0
  },
  {
    ...
    primary: "ST", secondary: "", ST: 76, CF: 69, CAM: 54, RW: 54, LW: 54, RM: 48, LM: 48, CM: 48, CDM: 35, RWB: 35, LWB: 35, RB: 35, LB: 35, CB: 26, GK: 0
  }
];
...
function calculatePositionRatings(player) {
  ...
  const ratings = {
    ...
    CF: Math.round((shooting * 0.35 + passing * 0.25 + pace * 0.2 + dribbling * 0.2) * 0.94),
...
async function main() {
  console.log('Starting corrected player data scraping...');
  ...
  try {
    ...
    for (let i = 0; i < newPlayerIds.length; i++) {
      ...
      if ((i + 1) % 100 === 0) {
        ...
        XLSX.writeFile(progressWorkbook, 'Data/player-data-progress-corrected.xlsx');
      }
    }
    
    // Create final Excel file
    console.log('Creating final Excel file...');
    ...
    XLSX.writeFile(workbook, 'Data/corrected-player-data.xlsx');
    
    console.log(`Excel file created successfully: ${path.resolve('Data/corrected-player-data.xlsx')}`);
