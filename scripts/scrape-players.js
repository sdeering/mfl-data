...
async function scrapePositionRatings(playerId, browser) {
...
async function main() {
  ...
  try {
    ...
    // Save to file
    XLSX.writeFile(workbook, 'Data/player-data.xlsx');
    
    console.log(`Excel file created successfully: ${path.resolve('Data/player-data.xlsx')}`);
