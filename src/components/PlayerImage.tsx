...
export default function PlayerImage({ player }: PlayerImageProps) {
  if (!player) {
    return (
      <div className="w-40 sm:w-[280px] md:w-[280px] xl:w-[280px] m-0 max-[412px]:w-[350px]">
    ...
    <div className="w-40 sm:w-[280px] md:w-[280px] xl:w-[280px] m-0 max-[412px]:w-[350px]">
      ...
      >
        <defs>
          ...
          <linearGradient href="#v2-b" id="v2-a" x1="106" x2="106" y1="151" y2="116" gradientUnits="userSpaceOnUse">
</linearGradient>
