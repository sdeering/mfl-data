...
import { ScrapedPositionRating } from '../services/mflPlayerInfoScraper';
...
export default function PositionRatingsDisplay({ player }: PositionRatingsDisplayProps) {
  ...
  const { positionRatings, isLoading, error, refetch } = useScrapedPositionRatings(player);
...
function PositionRatingItem({ rating, player }: { rating: ScrapedPositionRating; player: any }) {
